...
function NavigationBar() {
  ...
  return (
    <motion.div
      ...
      variants={variants}
      className="py-12 flex flex-col bg-white opacity-95 border items-center border-r-2 md:hidden w-full md:w-2/5 h-screen  fixed"
    >
      ...
      <div
        className="flex items-center justify-center rounded-full p-2 bg-[#f75748] text-white w-6 h-6 top-12 -right-3 absolute"
        onClick={() => setIsExpanded((val) => !val)}
      >
        <GiBackForth size={"32px"} />
      </div>
...
function NavigationBar2() {
  ...
  return (
    <motion.div
      animate={isExpanded ? "expanded" : "nonExpanded"}
      variants={variants2}
      className="py-12 hidden md:flex flex-col bg-white bg-opacity-95 border items-center border-r-2 w-full md:w-2/5 h-screen  fixed"
    >
      <NavLink to={`/home`}>
        <div className={`flex space-x-2 items-center `}>
          <img src="/assets/images/logo.png" className="w-10" alt="logo" />
