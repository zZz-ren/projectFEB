    ...
    return (
        <div>
            <div className="grid grid-cols-1 md:grid-cols-2  mx-auto">
                <div className="m-2">
                    ...
                    <div className=" grid grid-cols-3 mt-1 rounded-lg ">
                        <img src={link} className="" alt="img" />
                        <img src={link} className="" alt="img" />
                        <img src={link} className="" alt="img" />
                    </div>
                </div>
                <div className="m-2 space-y-2 ">
                    ...
                    <div className="rounded-xl w-1/2 flex flex-col p-5 shadow-lg">
                        Select Color:
            ...
            <div className=" flex justify-end mx-auto w-full">
                <button class="bg-gray-900 w-40 hover:bg-white hover:text-black text-white py-2 px-4 ">
                    Button
                </button>
            </div>
        </div>
